        ...
        <form method="post" action="{{ route('teacher.update', $teacher->id) }}">
            ...
            <div class="row">
                ...
                <div class="col-sm-6 mb-3">
                    ...
                    <input class="form-control form-control-lg" type="date" name="birth_date" value="{{ $teacher->birth_date }}">
                </div>
            </div>
            ...
            @foreach ($disciplines as $discipline)
                <div class="form-check">
                    <input type="checkbox" class="form-check-input" value="{{ $discipline->id }}" name="disciplines[]" id="check{{ $discipline->id }}" {{ ($teacher->disciplines->where('id', $discipline->id)->first()) ? 'checked=""' : '' }}>
